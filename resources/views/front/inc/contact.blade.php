    ...
    <div class="container">
     <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="{{ url('send_email') }}" method="post" id="contactForm" novalidate="novalidate">
            @csrf
            <div class="row">
              <div class="col-12">
